...
local barHeightOffset = 42         -- set value that healthbars for units that can unfold and become larger than its unitdef.height are still visible

local drawDistanceMult = 1

local barHeight = 8
local barWidth = 10         --// (barWidth)x2 total width!!!
local barAlpha = 0.75
...
local minPercentageDistance = 150000     -- always show health percentage text below this distance
...
local maxUnitDistance = 700000000  --max squared distance at which any info is drawn for units
...
do
	...
	local GetVisibleUnits = Spring.GetAllUnits
